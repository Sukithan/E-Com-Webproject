...
const Product1 = () => {
  const { productCategoriesFour, currency } = useContext(ShopContext);
  ...
  const fetchProductData = async () => {
    setProducts(productCategoriesFour);
  };
            ...
            <div className='flex flex-col sm:flex-row gap-8'>
              ...
              <div className='mb-4 sm:mb-0'>
                <img
                  ...
                  className='w-full h-auto object-cover max-w-[200px] sm:max-w-[300px] md:max-w-[300px]'
                />
              </div>
